...
public class SendMailAttach {
	...
	public SendMailAttach(String from, Address[] toList, String cc, String subject, String text, String attach, String logo) {
		super();
		this.from = from;
		this.cc = cc;
		this.subject = subject;
	...
	public SendMailAttach(String from, String to, Address[] toCc, String subject, String text, String attach, String logo) {
		super();
		this.from = from;
		this.to = to;
		this.subject = subject;
