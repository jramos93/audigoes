...
public class UsuarioActividad extends SuperEntity implements Serializable {
	...
	@Id
	@TableGenerator(name = "uac_id", schema = "audigoes", table = "contador", pkColumnName = "cnt_nombre", valueColumnName = "cnt_valor", pkColumnValue = "uac_id", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "uac_id")
	@Column(name="uac_id")
	private int uacId;
