...
public class CriterioMB extends AudigoesController implements Serializable {
	...
	public void exportarPDF(ActionEvent actionEvent) throws JRException, IOException {
		...
		JasperPrint jasperPrint = JasperFillManager.fillReport(jasper.getPath(),
				(java.util.Map<String, Object>) parametros, new JRBeanCollectionDataSource(this.getCriterios()));
	...
	public void fillListado() {
		try {
			setListado((List<Criterio>) audigoesLocal.findByNamedQuery(Criterio.class, "criterio.all",
