...
@FacesConverter(value = "tipoAuditoriaConverter")
public class TipoAuditoriaConverter implements Converter {
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
		try {
			int id = 0;
			TipoAuditoria registro;
			if (arg2.trim().equals("")) {
				registro = new TipoAuditoria();
				return registro;
			} else {
			...
			registro = (TipoAuditoria) getSecurityMB().getAudigoesLocal().findByPk(TipoAuditoria.class, id);
			if (registro == null) {
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
		try {
			if (arg2 != null && arg2.getClass().equals(TipoAuditoria.class)) {
				return String.valueOf(((TipoAuditoria) arg2).getTpaId());
			}
			return null;
		} catch (Exception e) {
			e.printStackTrace();
